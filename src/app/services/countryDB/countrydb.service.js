...
var CountryDbService = (function () {
    function CountryDbService() {
        this.regions = ['AFRICA', 'LATIN AMERICA AND THE CARIBBEAN', 'NORTHERN AMERICA', 'ASIA', 'EUROPE', 'OCEANIA'];
        this.subRegion = {
            'Region': ['Sub Region'],
    ...
    CountryDbService = __decorate([
        core_1.Injectable()
    ], CountryDbService);
    return CountryDbService;
}());
exports.CountryDbService = CountryDbService;
