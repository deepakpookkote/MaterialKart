...
export class CompareProductComponent  extends AppComponent  {
   pageContent = '';
   public service:any;
    public getApiUrl:any=this.ApiURL;
   public productData:any=[];
   public compareProd1:any={};public compareProd2:any={};public compareProd3:any={};
   public Product4Compare:any;
   public Product4CompareLength:any;
   public Product4ComparePID:any=[];
   public product:any={};
   public productsFullCategoryObj:any=[];
  //  public ProductParamerRef:any=['Solar Reflectance - 3 year aged','Solar Reflective Index - Initial (low-slope roof)','Kitchen Faucet flow rate - lpm/gpm at 60 Psi/415 kPa','WC flush rate - lpf/gpf','SHGC','U-value (W/sqm/K or Btu/h·sqft·°F)','Visible Light Transmittance','Life-Cycle Assessment','Environmental Product Declaration','FSC certified wood','Recycled Content','Bio-based material as per SAN SAS (tested as per ASTM D6866)','Health Product Declaration','Cradle to Cradle Certification','REACH compliant','ANSI/BIFMA e3 Furniture Sustainability Standard','Declare','VOC content','VOC emissions'];
   ...
   public searchObject1:any=""; public searchObject2:any=""; public searchObject3:any="";
   public hintProducts1:any=[];
   public hintProducts2:any=[];
   public hintProducts3:any=[];
   public orginalHintProducts:any=[];
   public hintContainer1:any=false;public hintContainer2:any=false;public hintContainer3:any=false;
   public searchHintLocked:any=[];
   public prodCompCategory:any="";
   public Prod1ChartArry:any=[];
   public Prod2ChartArry:any=[];
   public Prod3ChartArry:any=[];
   public Prod1Parameters:any=[]; public Prod2Parameters:any=[]; public Prod3Parameters:any=[];
   ...
   public SideVal:any="";
   public SideValcnt:number=0;

   public tname:any="aaa";
...
// alert (-1.23e-2.toFixed(9))
   ...
   public Res4:any="";
GetExponentionalVal(ParamName:any,p1:any,p2:any){
  let parent:any=this;
...
//  }
 ...
 public ProductParamerRef:any=[];
 // public GlobalProductobj:any = [];
   public GlobalProductobj:any=[];
  public GlobalProductArr:any=[];
    public FinalObj:any=[];

   getProductInformations(productId:any,idx:any){
      let parent:any=this;
 ...
 if(parent.compareProd1.parameters){
            for(let item of parent.compareProd1.parameters){
...
parent.GlobalProductobj[item.name]['p1']['submenu2']=item.submenu2;
 ...
 if(parent.compareProd2.parameters){
              for(let item of parent.compareProd2.parameters){
                if(parent.GlobalProductobj[item.name]==undefined){
                  parent.GlobalProductobj[item.name]=[];
...
// console.log('parent.FinalObj',parent.FinalObj);
 ...
 parent.ProductParamerRef = parent.productsFullCategoryObj.filter(function(item:any, i:any, ar:any){ return ar.indexOf(item) === i; });
      // console.log('parent.ProductParamerRef',parent.ProductParamerRef);
     	    });
   }
...
CheckThresold1(obj1:any,index:any){
...
CheckThresold2(obj2:any,index:any){
// console.log('CheckThresoldA',obj2);
  //let tickMark=document.getElementById("p"+index);
if( obj2.p2!=undefined ){
  if( obj2.p1==undefined ){ //tickMark.style.display="none";
   return 'tick'; }
...
Printf(data:any){
  ...
  //     return var1;
   //
  //  }
  public EnableSubmenu2:any=[];
  public Submenu2fullObj:any=[];
  public Submenu2Key:any="";

   CheckParameter(parameterRefId:any,ParameterObj:any,idx:any){
...
public submenu2ArrObj:any=[];
public submenu2ArrObjKey:any=[];

toArray(obj:any){ if(obj){
...
//console.log(this.globalService.getData());
 ...
 // }
   ...
   hintPull(val:any,id:any,idxx:any){
    //  console.log(val);
   ...
   getSingleProduct(pID:any,idx:any){
      let parent=this;
...
public ProdChartArry:any=[];
public ParamNameForChart:string="";
public paramAcidification:any=[];
...
public paramForChart:any=[];
CompareChartData(ParamName:any,p1:any,p2:any){
...
convertInt(ConvVal:any){
var OpConVal= parseFloat(ConvVal);
return OpConVal;
}

   loadChart(ParamName:any){
