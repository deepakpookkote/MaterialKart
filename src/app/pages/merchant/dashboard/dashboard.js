...
var MerchantDashboardComponent = (function (_super) {
    __extends(MerchantDashboardComponent, _super);
    function MerchantDashboardComponent(router, globalService, apiService) {
    ...
    MerchantDashboardComponent.prototype.loadChart = function () {
        this.WeekDay = [
            'Monday',
            'Tuesday',
            'Wednesday',
    ...
    MerchantDashboardComponent.prototype.loadBrowserChart = function () {
        Highcharts.setOptions({
            colors: ['#058DC7', '#50B432', '#ED561B', '#DDDF00', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
        });
    ...
    MerchantDashboardComponent.prototype.checkAccess = function () {
        var parent = this;
    ...
    MerchantDashboardComponent.prototype.getRecentActivity = function () {
        var parent = this;
    ...
    MerchantDashboardComponent.prototype.getProducts = function () {
        var parent = this;
    ...
    MerchantDashboardComponent.prototype.editProduct = function (productId) {
    ...
    MerchantDashboardComponent.prototype.deleteProduct = function (productId) {
        var parent = this;
        swal({
            title: 'Are you sure?',
    ...
    MerchantDashboardComponent.prototype.loadWorldMapChart = function () {
        $(".mapcontainer").mapael({
            map: {
...
exports.MerchantDashboardComponent = MerchantDashboardComponent;
